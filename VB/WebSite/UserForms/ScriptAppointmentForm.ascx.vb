...
Partial Public Class UserForms_ScriptAppointmentForm
    ...
    Protected Overrides Function GetChildControls() As Control()
        ...
        Dim controls_Renamed() As Control = { edtStartDate, edtEndDate, tbSubject, tbDescription, tbLocation, edtLabel, edtStatus, chkAllDay, chkRecurrence, recurrenceControl, btnOk, btnCancel, btnDelete, ddResource.FindControl("edtMultiResource"), ddResource}
